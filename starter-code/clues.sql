...
SELECT name, population FROM countries WHERE region='Southern Europe' ORDER BY population limit 1;
--RETURN: Holy See
...
SELECT language FROM countrylanguages WHERE isofficial = true AND countrycode = 'VAT';
--return ITALIAN
